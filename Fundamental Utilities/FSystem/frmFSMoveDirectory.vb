Public Class frmFSMoveDirectory
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        On Error GoTo ERH
RESTART:
        My.Computer.FileSystem.MoveDirectory(TextBox1.Text, DS, Microsoft.VisualBasic.FileIO.UIOption.AllDialogs, FileIO.UICancelOption.DoNothing)
        MsgBox("Directory Moved !!!", MsgBoxStyle.OkOnly + MsgBoxStyle.Information, "Success")
        Exit Sub
ERH:
        If MsgBox("Directory Moving failed !!!" & vbCrLf & ErrorToString() & vbCrLf & vbCrLf & "Retry ???", MsgBoxStyle.Critical + MsgBoxStyle.RetryCancel) = MsgBoxResult.Retry Then
            GoTo RESTART
        End If
    End Sub

    Private Sub frmFSMoveDirectory_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
