Public Class frmFSDirectoryAttributes
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        On Error GoTo ERH
        Dim ATT As IO.DirectoryInfo
        ATT = My.Computer.FileSystem.GetDirectoryInfo(TextBox1.Text)
...
ERH:
    ...
    Private Sub frmFSDirectoryAttributes_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
